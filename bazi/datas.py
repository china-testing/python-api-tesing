...
zhi_atts = {
    ...
    "巳":{"冲":"未", "刑":"申", "被刑":"寅", "合":("酉","巳"), "会":("午","未"), '害':'寅', '破':'申', "六合":"申",},
    "午":{"冲":"子", "刑":"午", "被刑":"午", "合":("寅","戌"), "会":("巳","未"), '害':'丑', '破':'卯', "六合":"未",},
    "未":{"冲":"丑", "刑":"戌", "被刑":"未", "合":("卯","亥"), "会":("巳","午"), '害':'子', '破':'戌', "六合":"午",},
...
gan_hes = {
    ...
    ("乙", "庚"): '''
    仁义之合　化金 果敢有守, 不惑柔佞,周旋唯仁,进退唯义。
    五行生旺则骨秀形清,若死个性果敢刚健，很重义气。若四柱中有七杀，或逢死绝者，勇而无谋。
    绝带煞则使气好勇,体貌不扬,自是非人。甲己、乙庚之合, 妇人不忌。''',
    ("丙", "辛"): '''
    威制之合　化水 仪表威肃,人多畏惧,酷毒,好贿喜淫,若带煞或五行死绝则寡恩少义,无情之人。
    妇人得之,与天中、大耗、咸池相并者,貌美声卑,夭冶而淫。''',
    ("丁", "壬"): '''
    淫慝之合　化木 眼明神娇, 多情易动,不事高洁,习下无去,枕欢溺色,于我则吝,于彼则贪,
    若五行死绝或带煞,见咸池、大耗、天中自败,有淫污家风之丑;亲厚小人,侮慢君子,贪婪妄作,
    必胜而后已。妇人淫邪奸慝,易挑易诱,多招玷辱,或年高而嫁少夫,或年幼而配老夫,
    或先贱而后良,或先良而后贱。''',    
    ("戊", "癸"): '''
    无情之合　化火 合而无情,主人或好或丑,如戊得癸则娇媚,姿美得所,男子娶少妇,妇人嫁美夫; 
